...
# Distance between consecutive locations, excluding return trip to the origin
itinerary = D[x[:-1], x[1:]]

# Print the array itinerary
print("The distances between consecutive locations, excluding return trip to the origin is:", itinerary)
