...
#TODO: Compute the total distance traveled between consecutive locations, excluding the return trip to the origin. 
...
#TODO: Compute the total distance traveled between locations, including the return trip to the origin.
